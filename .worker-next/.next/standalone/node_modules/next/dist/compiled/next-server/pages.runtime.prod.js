...
Read more: https://nextjs.org/docs/messages/invalid-getstaticpaths-value`);let eR=l.resolvedAsPath||n.url;if(w){let{isValidElementType:e}=r("./dist/compiled/react-is/index.js");if(!e(ed))throw Error(`The default export is not a React Component in page: "${a}"`);if(!e(ea))throw Error('The default export is not a React Component in page: "/_app"');if(!e(el))throw Error('The default export is not a React Component in page: "/_document"');if((e_||eu)&&(i={...i.amp?{amp:i.amp}:{}},eR=`${a}${n.url.endsWith("/")&&"/"!==a&&!eS?"/":""}`,n.url=a),"/404"===a&&(eb||M))throw Error(`\`pages/404\` ${R.Ei}`);if(j.Er.includes(a)&&(eb||M))throw Error(`\`pages${a}\` ${R.Ei}`)}for(let e of["getStaticProps","getServerSideProps","getStaticPaths"])if(null==ed?void 0:ed[e])throw Error(`page ${a} ${e} ${R.lk}`);await H.preloadAll(),(ev||M)&&!eu&&F&&(m=!1!==(h=e(n,s,F)));let ej=new e0(a,i,eR,{isFallback:eu},!!(M||eb||!ex&&!ev||et),W,l.locale,l.locales,l.defaultLocale,l.domainLocales,m,ee(n,"isLocaleDomain")),eC={back(){ej.back()},forward(){ej.forward()},refresh(){ej.reload()},fastRefresh(){},push(e,t){let{scroll:r}=void 0===t?{}:t;ej.push(e,void 0,{scroll:r})},replace(e,t){let{scroll:r}=void 0===t?{}:t;ej.replace(e,void 0,{scroll:r})},prefetch(e){ej.prefetch(e)}},eT={},eE=(0,_.createStyleRegistry)(),e$={ampFirst:!0===C.amp,hasQuery:!!i.amp,hybrid:"hybrid"===C.amp},eN=function(e){let{ampFirst:t=!1,hybrid:r=!1,hasQuery:n=!1}=void 0===e?{}:e;return t||r&&n}(e$),eA=function(e){void 0===e&&(e=!1);let t=[(0,y.jsx)("meta",{charSet:"utf-8"})];return e||t.push((0,y.jsx)("meta",{name:"viewport",content:"width=device-width"})),t}(eN),eD=[],eF={};ew&&(eF.beforeInteractive=[].concat(ew()).filter(e=>"beforeInteractive"===e.props.strategy).map(e=>e.props));let eH=({children:e})=>(0,y.jsx)(eW.Provider,{value:eC,children:(0,y.jsx)(eM.Provider,{value:ej.isReady&&ej.query?new URL(ej.asPath,"http://n").searchParams:new URLSearchParams,children:(0,y.jsx)(eU,{router:ej,isAutoExport:e_,children:(0,y.jsx)(eq.Provider,{value:function(e){if(!e.isReady||!e.query)return null;let t={};for(let r of Object.keys(function(e){let{parameterizedRoute:t,groups:r}=function(e){let t=em(e).slice(1).split("/"),r={},n=1;return{parameterizedRoute:t.map(e=>{let t=U.find(t=>e.startsWith(t)),o=e.match(/\[((?:\[.*\])|.+)\]/);if(t&&o){let{key:e,optional:s,repeat:a}=ez(o[1]);return r[e]={pos:n++,repeat:a,optional:s},"/"+eB(t)+"([^/]+?)"}if(!o)return"/"+eB(e);{let{key:e,repeat:t,optional:s}=ez(o[1]);return r[e]={pos:n++,repeat:t,optional:s},t?s?"(?:/(.+?))?":"/(.+?)":"/([^/]+?)"}}).join(""),groups:r}}(e);return{re:RegExp("^"+t+"(?:/)?$"),groups:r}}(e.pathname).groups))t[r]=e.query[r];return t}(ej),children:(0,y.jsx)(B.Provider,{value:ej,children:(0,y.jsx)(L.Provider,{value:e$,children:(0,y.jsx)(O.Provider,{value:{updateHead:e=>{eA=e},updateScripts:e=>{eT=e},scripts:eF,mountedInstances:new Set},children:(0,y.jsx)(A.Provider,{value:e=>eD.push(e),children:(0,y.jsx)(_.StyleRegistry,{registry:eE,children:(0,y.jsx)(eO.Provider,{value:Z,children:e})})})})})})})})})}),eG=()=>null,eJ=({children:e})=>(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(eG,{}),(0,y.jsx)(eH,{children:(0,y.jsxs)(y.Fragment,{children:[w?(0,y.jsxs)(y.Fragment,{children:[e,(0,y.jsx)(eG,{})]}):e,(0,y.jsx)(eG,{})]})})]}),eV={err:b,req:e_?void 0:n,res:e_?void 0:s,pathname:a,query:i,asPath:eR,locale:l.locale,locales:l.locales,defaultLocale:l.defaultLocale,AppTree:e=>(0,y.jsx)(eJ,{children:e1(ea,ed,{...e,router:ej})}),defaultGetInitialProps:async(e,t={})=>{let{html:r,head:n}=await e.renderPage({enhanceApp:e=>t=>(0,y.jsx)(e,{...t})}),o=eE.styles({nonce:t.nonce});return eE.flush(),{html:r,head:n,styles:o}}},eX=!ev&&(l.nextExport||w&&(e_||eu)),eZ=()=>{let e=eE.styles();return eE.flush(),(0,y.jsx)(y.Fragment,{children:e})};if(f=await X(ea,{AppTree:eV.AppTree,Component:ed,router:ej,ctx:eV}),(ev||M)&&m&&(f.__N_PREVIEW=!0),ev&&(f[j.NO]=!0),ev&&!eu){let e,t;try{e=await (0,en.getTracer)().trace(eo.xj.getStaticProps,{spanName:`getStaticProps ${a}`,attributes:{"next.route":a}},()=>I({...eS?{params:i}:void 0,...m?{draftMode:!0,preview:!0,previewData:h}:void 0,locales:l.locales,locale:l.locale,defaultLocale:l.defaultLocale,revalidateReason:l.isOnDemandRevalidate?"on-demand":ey?"build":"stale"}))}catch(e){throw e&&"ENOENT"===e.code&&delete e.code,e}if(null==e)throw Error(R.q6);let r=Object.keys(e).filter(e=>"revalidate"!==e&&"props"!==e&&"redirect"!==e&&"notFound"!==e);if(r.includes("unstable_revalidate"))throw Error(R.Eo);if(r.length)throw Error(e4("getStaticProps",r));if("notFound"in e&&e.notFound){if("/404"===a)throw Error('The /404 page can not return notFound in "getStaticProps", please remove it to continue!');v.isNotFound=!0}if("redirect"in e&&e.redirect&&"object"==typeof e.redirect){if(e2(e.redirect,n,"getStaticProps"),ey)throw Error(`\`redirect\` can not be returned from getStaticProps during prerendering (${n.url})
